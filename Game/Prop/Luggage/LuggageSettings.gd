...
const luggage_settings : Dictionary = {
	"light": {
		"model_path": "res://Game/Prop/Luggage/Model/LuggageModelLight.tscn",
		"name": "light",
		"spawn_probability": 2.0/6,
		"weight": .2
	},
	"medium" : {
		"model_path": "res://Game/Prop/Luggage/Model/LuggageModelMedium.tscn",
		"name": "medium",
		"spawn_probability": 3.0/6,
		"weight": .4
	},
	"heavy": {
		"model_path": "res://Game/Prop/Luggage/Model/LuggageModelHeavy.tscn",
		"name": "heavy",
...
static func random_luggage_settings():
	var r = randf()
